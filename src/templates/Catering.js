...
const CateringTemplate = () => (
    <div>
        ...
        <div className="w3-top" style={{position: 'relative'}}>
        ...
        <header className="w3-display-container w3-content w3-wide" style={{maxWidth:1600,minWidth:500}} id="home">
            <img className="w3-image" src="https://static.pexels.com/photos/461198/pexels-photo-461198.jpeg" alt="Hamburger Catering" width="1600" height="800" />
        ...
        <div className="w3-content" style={{maxWidth:1100}}>
            ...
            <div className="w3-row w3-padding-64" id="about">
                <div className="w3-col m6 w3-padding-large w3-hide-small">
                    <img src="https://static.pexels.com/photos/461198/pexels-photo-461198.jpeg" className="w3-round w3-image w3-opacity-min" alt="Table Setting" width="600" height="750" />
                </div>
      ...
      <h4>Honey Almond Granola with Fruits</h4>
                ...
                <div className="w3-col l6 w3-padding-large">
                    <img src="https://static.pexels.com/photos/461198/pexels-photo-461198.jpeg" className="w3-round w3-image w3-opacity-min" alt="Menu" style={{width:'100%'}} />
                </div>
            </div>
            ...
            <hr />
                ...
                <div className="w3-container w3-padding-64" id="contact">
                    ...
                    <form action="/action_page.php" target="_blank">
                        ...
                        <p><input className="w3-input w3-padding-16" type="datetime-local" placeholder="Date and time" required name="date" value="2017-11-16T20:00" /></p>
